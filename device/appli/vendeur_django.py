...
if cible:
    ...
    root_address=ROOT_PATH+"../a copier/"
    ...
    fichierBackup_Template=dir_Root+'%s.bak'
    fichierTemp_Template=dir_Root+'%s.tmp'
    fichierOld_Template=dir_Root+'%s.old'
