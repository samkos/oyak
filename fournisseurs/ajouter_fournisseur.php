	   ...
	   else
	   {
		  ...
		  else
		  {
			 ...
			 else
			 {
				...
				$req = mysql_query("insert into ".$prefixe_table."fournisseurs values ('','$civilite','$nom','$prenom','$societe','$adresse','$adresse2','$ville','$code_postal','$pays','$telephone','$fax','$portable','$email','$clef',NULL)");
